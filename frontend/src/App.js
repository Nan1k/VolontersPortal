    ...
    <ThemeProvider>
      ...
      <div className="container">
        <Routes>
          ...
          {/* Temporary demo routes without auth/role checks */}
          <Route path="/demo/volunteer" element={<VolunteerPage />} />
          <Route path="/demo/cityadmin" element={<CityAdminPage />} />
          <Route path="/demo/regionadmin" element={<RegionAdminPage />} />
